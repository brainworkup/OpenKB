...
- whether any non-founder built the product
- what [[concepts/ai-code-generation]] tools, AI models, and technical stack are being used
...
- how long each founder has worked on it
...
- whether people are using the product
- active users or customers
- how many are paying
- monthly revenue and revenue sources
...
- why the founder picked the idea
- whether they have domain expertise
- how they know people need it
...
- a clear explanation of the product and business model
- reasons for applying to YC
- concise written responses about accomplishments and prior work
...
- prior investment
- current fundraising
- prior incubator participation
- previous YC applications and pivots
...
- a time they most successfully hacked a non-computer system to their advantage
- the most impressive thing they have built or achieved other than the current startup
- prior projects, products, or open source work
...
- **Technical capability:** Can the founder build or direct product creation effectively?
- **Execution speed:** Are they making rapid progress with limited resources?
- **User understanding:** Do they understand the problem and customer deeply?
- **Traction:** Is there measurable evidence that users care?
- **Commitment:** Are they fully engaged and persistent?
- **Judgment:** Do they make good decisions about product, market, and strategy?
- **Communication:** Can they explain the company simply and persuasively?
- **Ambition:** Are they targeting a meaningful outcome?
- **Credibility:** Do the facts about ownership, fundraising, and history hold together coherently?
...
[[summaries/README_20260413212108]] sharpens this further by listing the accomplishment prompts in a compact standalone form: hacking a non-computer system, naming the most impressive thing built or achieved outside the startup, listing prior builds with URLs, and listing competitions, awards, or papers. This makes visible how founder evaluation extends beyond startup traction into general evidence of ingenuity, builder history, and external validation.

[[summaries/README_20260413215204]] reinforces the same pattern in another concise YC application draft. It presents the accomplishment prompts as founder-background questions tied to an [[concepts/application-preparation]] workflow, highlighting that these are not incidental extras but a structured way of eliciting evidence of initiative, prior execution, and external validation. Its inclusion of an application link and a staged question list also underscores how founder evaluation is prepared deliberately: founders are expected to curate examples that demonstrate resourcefulness, builder identity, and exceptional outcomes.

[[summaries/README_20260413235016]] adds a more strategic layer. Rather than only listing prompts, it describes an application research foundation covering partner preferences, solo founder positioning, competitive landscape analysis, market sizing, healthcare-related regulatory positioning, local-LLM viability through [[concepts/mlx-framework]], and tactical guidance for each section of the application including the [[concepts/coding-agent-session]]. This shows that founder evaluation is not limited to biography or traction; it also depends on whether the founder can assemble a coherent, evidence-based case for why the company is credible, technically feasible, differentiated, and worth backing.
